...
function getSoapBody(soapData) {
	// helper function to deal with caps/lowercase screw ups by Netgear
	try {
		let keyEnvelope;
		let keyBody;
		...
		return Promise.resolve(soapData[keyEnvelope][keyBody][0]);
	} catch (error) {
		return Promise.reject(Error('Error parsing soap body'));
	}
}
