...
class NetgearRouter {
	...
	// 			.then((result) => {
	// 				// const patchedBody = result.body.replace(/<m:GetInfoRespons([^]+)DeviceInfo:1">/g, '<m:GetInfoResponse>');
	// 				// console.log(patchedBody);
	// 				const doc = pjxml.parse(result.body);
	// 				// const el = doc.select('//m:GetInfoResponse');
	// 				const info = {
	// 				ModelName:	result.body.match(/<ModelName>(.*)<\/ModelName>/)[1],
	// 				Description: result.body.match(/<Description>(.*)<\/Description>/)[1],
	// 				SerialNumber: result.body.match(/<SerialNumber>(.*)<\/SerialNumber>/)[1],
	// 				Firmwareversion: result.body.match(/<Firmwareversion>(.*)<\/Firmwareversion>/)[1],
	// 				SmartAgentversion: result.body.match(/<SmartAgentversion>(.*)<\/SmartAgentversion>/)[1],
	// 				// FirewallVersion: result.body.match(/<FirewallVersion>(.*)<\/FirewallVersion>/)[1],
	// 				// OthersoftwareVersion: result.body.match(/<OthersoftwareVersion>(.*)<\/OthersoftwareVersion>/)[1],
	// 				// Hardwareversion: result.body.match(/<Hardwareversion>(.*)<\/Hardwareversion>/)[1],
	// 				// Otherhardwareversion: result.body.match(/<Otherhardwareversion>(.*)<\/Otherhardwareversion>/)[1],
	// 				// FirstUseDate: result.body.match(/<FirstUseDate>(.*)<\/FirstUseDate>/)[1],
	// 				// FirmwareDLmethod: result.body.match(/<FirmwareDLmethod>(.*)<\/FirmwareDLmethod>/)[1],
	// 				// DeviceMode: result.body.match(/<DeviceMode>(.*)<\/DeviceMode>/)[1],
	// 			}
  //
	// 				// Object.keys(el.content).forEach((key) => {
	// 				// 	const routerInfo = el.content[key].content;
	// 				// 	if (routerInfo === undefined) { return; }
	// 				// 	if (Array.isArray(routerInfo)) {
	// 				// 		console.log(el.content[key].name);
	// 				// 		console.log(routerInfo[0]);
	// 				// 		info[el.content[key].name] = routerInfo[0];
	// 				// 	}
	// 				// });
	...
	// 				// const doc = pjxml.parse(patchedBody);
	// 				const doc = pjxml.parse(result.body);
	// 				console.log(doc);
